...
rm -rf  /Users/span/projects/stockmri/scripts/ttestplus_stock_masked
mkdir /Users/span/projects/stockmri/scripts/ttestplus_stock_masked

cd /Users/span/projects/stockmri/scripts/ttestplus_stock_masked
...
foreach outfile (${outfiles})
	...
	echo ""
        ...
        if ( -e ${outfile}z+tlrc.HEAD ) then
                rm -rf ${outfile}z+tlrc.*
        endif

	3dttest++ -prefix ./${outfile}_z -dupe_ok -toz -setA \
